...
const MODELS: Array<{
  ...
  },
  {
    ...
    options: [
      ...
      { provider: "openrouter", model_id: "google/gemini-3.1-pro",       label: "Gemini 3.1 Pro",    hint: "Google flagship, huge context" },
      { provider: "openrouter", model_id: "google/gemini-3.1-flash",     label: "Gemini 3.1 Flash",  hint: "cheap + fast Google" },
