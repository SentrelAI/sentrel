...
Rails.application.configure do
  ...
  # Redis cache store (same as production)
  ...
  # Allow the engine running in Docker to call Rails via host.docker.internal.
  config.hosts << "host.docker.internal"
  # Skip DNS rebinding protection on API / health endpoints the engine hits.
  config.host_authorization = {
    exclude: ->(request) { request.path.start_with?("/api/", "/up") }
  }
end
